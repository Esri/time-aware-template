...
define({
  ...
  "time": {
    ...
    "play": "Reproducir",
    "pause": "Pausa",
    "timeSpeed": "Cambiar velocidad",
    "enableTimeMessage": "El mapa web especificado no contiene ninguna capa con función de tiempo habilitada. Consulta el tema de la ayuda ${link} para obtener más información. Para usar la plantilla sin mostrar el tiempo, utiliza el panel de configuración para deshabilitar la opción de tiempo.",
